...
Two-pass resolution architecture for branches and labels, a "Pipeline Debug" mode for hazard injection, and native export for `.hex` and `.mif` formats
Currently supports  RV32I.
